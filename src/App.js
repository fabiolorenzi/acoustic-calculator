...
import FrequenceOfResonanceTutorial from "./components/FrequenceOfResonanceTutorial.jsx";
    ...
    return(
        <div className="mainContainer">
            ...
            <Switch>
                ...
                <Route path="/tutorials/frequence-of-resonance-tutorial" component={FrequenceOfResonanceTutorial} />
